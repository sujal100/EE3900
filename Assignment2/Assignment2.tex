...
\begin{lstlisting}
https://github.com/https://github.com/sujal100/EE3900/blob/main/Assignment2/Assignment2.tex
\end{lstlisting}

Download all python codes from 

\begin{lstlisting}
https://github.com/https://github.com/sujal100/EE3900/blob/main/Assignment2/codes/code.py
\end{lstlisting}
\section{Problem}
(Matrix 2.11) If $x \myvec{2 \\ 3} + y \myvec{-1 \\ 1} = \myvec{10 \\ 5}$, find the values of $x$ and $y$.
\section{Solution}
Given equation can be represented in a form as
\begin{equation}
\myvec{2 & -1 \\ 3 & 1}\myvec{x \\ 4} = \myvec{10 \\ 5}
\end{equation}
